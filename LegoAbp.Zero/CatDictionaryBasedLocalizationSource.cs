...
namespace LegoAbp.Zero
{
    ...
    /// </summary>
    public class CatDictionaryBasedLocalizationSource : IDictionaryBasedLocalizationSource
    {
        /// <summary>
        ...
        public CatDictionaryBasedLocalizationSource(string name, ILocalizationDictionaryProvider dictionaryProvider)
        {
        ...
        public virtual void Initialize(ILocalizationConfiguration configuration, IIocResolver iocResolver)
        {
            ...
            _logger = iocResolver.IsRegistered(typeof(ILoggerFactory))
                ? iocResolver.Resolve<ILoggerFactory>().Create(typeof(CatDictionaryBasedLocalizationSource))
                : NullLogger.Instance;
