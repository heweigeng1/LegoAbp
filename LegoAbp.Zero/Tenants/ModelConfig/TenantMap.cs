...
namespace LegoAbp.Zero.Tenants.ModelConfig
{
    public class TenantMap : EntityConfigurationBase<Tenant, int>
    {
        ...
        public const long defaultTenantUserKey = 1;
        ...
        public override void Configure(EntityTypeBuilder<Tenant> builder)
        {
            ...
            //添加租户用户
            //builder.HasData(new TenantUser { Id = defaultTenantUserKey, CreationTime = DateTime.Now, NickName = UsertMap.defaultName, PhoneNumber = tenantUserPhoneNumber, TenantId = defaultkey, UserId = UsertMap.defaultKey, });
        }
    }
}
