...
namespace LegoAbp.Migrations
{
    ...
    [Migration("20190322165435_init5")]
    partial class init5
    {
            ...
            modelBuilder.Entity("LegoAbp.Zero.Authorization.Roles.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ConcurrencyStamp = "52de781c-d9b4-4612-a118-7d1420457ef0", CreationTime = new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), DisplayName = "超级管理员", IsDefault = false, IsDeleted = false, IsStatic = false, Name = "admin", NormalizedName = "ADMIN" }
                    );
                });
