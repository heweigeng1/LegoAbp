            ...
            modelBuilder.Entity("LegoAbp.Zero.Authorization.Roles.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ConcurrencyStamp = "2c907296-b4c0-4d1b-85b6-d4311def205a", CreationTime = new DateTime(2019, 3, 20, 14, 25, 34, 327, DateTimeKind.Local), DisplayName = "超级管理员", IsDefault = false, IsDeleted = false, IsStatic = false, Name = "admin", NormalizedName = "ADMIN" }
                    );
                });
            ...
            modelBuilder.Entity("LegoAbp.Zero.Authorization.Users.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, AccessFailedCount = 0, ConcurrencyStamp = "236fe31e-5295-42f4-88d0-4ea7305cce5b", CreationTime = new DateTime(2019, 3, 20, 14, 25, 34, 127, DateTimeKind.Local), IsActive = true, IsDeleted = false, IsEmailConfirmed = false, IsLockoutEnabled = true, IsPhoneNumberConfirmed = false, IsTwoFactorEnabled = false, Name = "admin", NormalizedUserName = "ADMIN", Password = "AQAAAAEAACcQAAAAECoy2paeqzGYhjiamj229GCxo83A4ZRYk4i6HNRw/uNPamRDmxfnXkLNVnQcPSCCmw==", SecurityStamp = "ce8f76c4-bf38-f532-fbcf-39ecabf39baf", Sex = 0, UserName = "admin" }
                    );
                });
            ...
            modelBuilder.Entity("LegoAbp.Zero.Tenants.Domain.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreationTime = new DateTime(2019, 3, 20, 14, 25, 34, 114, DateTimeKind.Local), IsActive = true, IsDeleted = false, Name = "default", TenancyName = "default", TenantCode = "default" }
                    );
                });
            ...
            modelBuilder.Entity("LegoAbp.Zero.Tenants.Domain.TenantUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, CreationTime = new DateTime(2019, 3, 20, 14, 25, 34, 122, DateTimeKind.Local), IsDeleted = false, NickName = "admin", PhoneNumber = "13333333333", TenantId = 1, UserId = 1L }
                    );
                });
